    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                createShaped(RecipeCategory.MISC, ModItems.THE_GREAT_INDOORS_MUSIC_DISC)
                ...
                createShaped(RecipeCategory.MISC, ModItems.SON_OF_A_BIRCH_MUSIC_DISC)
                        .input('R', ModItems.RESONATOR)
                        .input('L', Items.BIRCH_LOG)
                        .input('S', Items.SKELETON_SKULL)
                        .input('N', ItemTags.BUNDLES)
                ...
                createShaped(RecipeCategory.MISC, ModItems.THORNS_MUSIC_DISC)
                        .input('R', ModItems.RESONATOR)
                        .input('L', Items.LANTERN)
                ...
                createShaped(RecipeCategory.MISC, ModItems.KEEP_OFF_THE_GRASS_MUSIC_DISC)
                        .input('R', ModItems.RESONATOR)
                        .input('L', Items.LANTERN)
                        .input('S', Items.SKELETON_SKULL)
                        .input('N', ItemTags.BUNDLES)
                ...
                createShaped(RecipeCategory.MISC, ModItems.DEALS_OF_THE_DOORS_MUSIC_DISC)
                ...
                createShaped(RecipeCategory.MISC, ModItems.CONTENT_CONTENT_CONTENT_MUSIC_DISC)
                        .input('D', ModItems.DAWN_OF_THE_DOORS_MUSIC_DISC)
                        .input('I', ModItems.INSTRUMENT_SHUFFLER)
                        .input('S', Items.SUGAR)
                ...
                createShaped(RecipeCategory.MISC, ModItems.THE_MINES_TEASER_MUSIC_DISC)
                        .input('R', ModItems.RESONATOR)
                        .input('S', Items.STONE)
                        .input('I', Items.IRON_BARS)
                        .input('W', Items.WATER_BUCKET)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.THE_MINES_TRAILER_MUSIC_DISC)
